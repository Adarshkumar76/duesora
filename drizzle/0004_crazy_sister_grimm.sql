...
--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "category" varchar(60);--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "owner_id" uuid;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "amount_minor" integer;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "currency" varchar(3) DEFAULT 'USD' NOT NULL;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "billing_cycle" varchar(20) DEFAULT 'yearly' NOT NULL;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "renewal_date" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN IF NOT EXISTS "auto_renew" boolean DEFAULT true NOT NULL;--> statement-breakpoint
DO $$ BEGIN
