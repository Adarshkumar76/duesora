...
function RegisterForm() {
  ...
  const displayError =
    ...
    (urlError === "Configuration"
      ? "OAuth provider not configured yet. Set AUTH_GITHUB_ID & AUTH_GITHUB_SECRET or AUTH_GOOGLE_ID & AUTH_GOOGLE_SECRET in your .env.local file to enable social signup."
