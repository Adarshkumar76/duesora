...
export interface TranslationDictionary {
  ...
  landing: {
    ...
    bento2Desc: string;
    bento2Tag: string;
    bento2Accuracy: string;
    bento3Title: string;
    bento3Desc: string;
    bento4Title: string;
    bento4Desc: string;
    bento4CertChain: string;
    bento4CertValid: string;
    bento4AutoRenew: string;
    bento4AutoRenewVal: string;
    categoriesTag: string;
    categoriesTitle: string;
    categoriesSubtitle: string;
    tabDomains: string;
    tabDomainsDesc: string;
    tabSubscriptions: string;
    tabSubscriptionsDesc: string;
    tabCloud: string;
    tabCloudDesc: string;
    tabSsl: string;
    tabSslDesc: string;
    nextRenewal: string;
    trackCustomAssets: string;
    selfHostTag: string;
    selfHostTitle: string;
    selfHostSubtitle: string;
    zeroTrackingTitle: string;
    zeroTrackingDesc: string;
    lightningFastTitle: string;
